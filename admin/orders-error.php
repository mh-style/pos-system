                            ...
                            <tbody>
                                <?php foreach($orders as $orderItem):?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="orders-view.php?track=<?= $orderItem['tracking_no'];?>" class="btn btn-info mb-2 px-3">View</a>
                                            <a href="orders-view-print.php?track=<?= $orderItem['tracking_no'];?>" class="btn btn-primary mb-2 px-3">Print</a>
                                        </td>
                                    </tr>
                                <?php endforeach;?>
                            </tbody>
