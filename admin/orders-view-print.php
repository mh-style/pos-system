            ...
            <div id="myBillingArea">
                <?php
                    if(isset($_GET['track'])){
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="text-align: center;" colspan="2">
                                                            <h4 style="font-size: 23px; line-height:30px; margin:2px; padding:0;">MH-Style
                                                            </h4>
                                                            <p style="font-size: 16px; line-height:24px; margin:2px; padding:0;">#555, 1st
                                                                street, bangladesh</p>
                                                            <p style="font-size: 16px; line-height:24px; margin:2px; padding:0;">MH-style
                                                                pvt ltd.</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <h5 style="font-size: 20px; line-height:30px; margin:0px; padding:0;">Customer
                                                                Details</h5>
                                                    ...
                                                    <tr>
                                                        <td align="end">
                                                            <h5 style="font-size: 20px; line-height:30px; margin:0px; padding:0;">Invoice
                                                                Details</h5>
                                                            <p style="font-size: 14px; line-height:20px; margin:0px; padding:0;">Invoice No:
                                                                <?= $orderDataRow['invoice_no'];?></p>
                        ...
                        $orderItemQuery = "SELECT oi.price as orderItemPrice, oi.quantity as orderItemQuantity,o.*, oi.*,p.* FROM orders o, order_items oi, products p WHERE oi.order_id = o.id AND p.id = oi.product_id AND o.tracking_no ='$trackingNo'";
